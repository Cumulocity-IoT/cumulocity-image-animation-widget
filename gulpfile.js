...
const bundle = series(
    ...
    function copySampleConfigurationJson() { return fs.copy('./configuration-samples', './dist/widget/configuration-samples')},
    function createZip() {
...
exports.default = series(clean, compile, bundle, async function success() {
    ...
    console.log("Runtime Widget Output (Install in the browser): dist/image-animation-widget.zip");
